...
export class Aureus extends ethereum.SmartContract {
  static bind(address: Address): Aureus {
    return new Aureus("Aureus", address);
  }
...
export class MintnewCall extends ethereum.Call {
  get inputs(): MintnewCall__Inputs {
    return new MintnewCall__Inputs(this);
  }

  get outputs(): MintnewCall__Outputs {
    return new MintnewCall__Outputs(this);
  }
}

export class MintnewCall__Inputs {
  _call: MintnewCall;

  constructor(call: MintnewCall) {
    this._call = call;
  }
...
export class MintnewCall__Outputs {
  _call: MintnewCall;
